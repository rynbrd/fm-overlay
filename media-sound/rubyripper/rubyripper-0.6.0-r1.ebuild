...
SRC_URI="http://${PN}.googlecode.com/files/${MYP}.tar.bz2"
...
# fix for bug 203737
RUBY_PATCHES=("${FILESDIR}/01-fm-preemp.patch"
	"${FILESDIR}/02-fm-titles.patch"
	"${FILESDIR}/03-fm-fastcmp.patch"
	"${FILESDIR}/04-fm-nodigest.patch"

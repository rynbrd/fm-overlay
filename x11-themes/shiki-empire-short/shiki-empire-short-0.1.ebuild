...
MY_PN="Shiki Empire Short"

DESCRIPTION="Shiki Empire Short Emerald Theme"
HOMEPAGE=""
...
src_prepare() {
	epatch "${FILESDIR}/${PV}-theme.patch"
	cp -f "${FILESDIR}/${PV}-pixmaps.active_bottom.png" "$S/pixmaps.active_bottom.png"
}

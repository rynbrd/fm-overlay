...
# Extra filters
HTTP_SUBSTITUTIONS_FILTER_PV="0.6.2"
HTTP_SUBSTITUTIONS_FILTER_PN="ngx_http_substitutions_filter_module"
HTTP_SUBSTITUTIONS_FILTER_P="${HTTP_SUBSTITUTIONS_FILTER_PN}-${HTTP_SUBSTITUTIONS_FILTER_PV}"
HTTP_SUBSTITUTIONS_FILTER_USER="yaoweibin"
HTTP_SUBSTITUTIONS_FILTER_REF="27a01b3"
HTTP_SUBSTITUTIONS_FILTER_MYP="${HTTP_SUBSTITUTIONS_FILTER_USER}-${HTTP_SUBSTITUTIONS_FILTER_PN}-${HTTP_SUBSTITUTIONS_FILTER_REF}"
HTTP_SUBSTITUTIONS_FILTER_URI="https://github.com/${HTTP_SUBSTITUTIONS_FILTER_USER}/${HTTP_SUBSTITUTIONS_FILTER_PN}/tarball/${HTTP_SUBSTITUTIONS_FILTER_PV}"
...
SRC_URI="http://nginx.org/download/${P}.tar.gz
	...
	nginx_modules_http_substitutions_filter? ( ${HTTP_SUBSTITUTIONS_FILTER_URI} -> ${HTTP_SUBSTITUTIONS_FILTER_P}.tar.gz )"
...
src_configure() {
	...
	if use nginx_modules_http_substitutions_filter; then
		http_enabled=1
		myconf+=" --add-module=${WORKDIR}/${HTTP_SUBSTITUTIONS_FILTER_MYP}"
	fi
